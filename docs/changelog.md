...
**Replaces:** `/update`, `/announce`, `/botupdates` **Saves:** 2 command slots
...
**Replaces:** `/petshop`, `/adopt`, `/petstatus`, `/feed`, `/play`, `/petname`, `/release` **Saves:** 6 command slots
...
**Replaces:** `/addcoins`, `/removecoins` **Saves:** 1 command slot
...
**Replaces:** `/warn`, `/warnings`, `/clearwarnings` **Saves:** 2 command slots
...
**Replaces:** `/botinfo`, `/ping`, `/uptime` **Saves:** 2 command slots
